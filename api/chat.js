/**
 * Serverless / Backend API Endpoint for Akeel AI Chatbot
 * Compatible with Vercel Serverless Functions, Netlify Functions, and Node.js / Express.
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (apiKey) {
      // Call official Google Gemini API (Interactions API / REST v1beta)
