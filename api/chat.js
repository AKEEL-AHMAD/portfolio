...
• CODTECH IT Solutions Pvt. Ltd. (Cyber Security & Ethical Hacking Intern, Oct 3 – Nov 3, 2025): Reconnaissance, Nmap port scanning, vulnerability assessments, exploit vector verifications, and technical mitigation reporting.
• Captain, State Cricket Team: Led the team to 3 championship titles; developed high-pressure composure, leadership, and tactical discipline.
• Career Objective: Seeking a Software Development Engineer (SDE) Intern role to design and build scalable, reliable software.
...
- If asked about hiring or contacting Akeel, provide his email (peerakeel9027@gmail.com), phone (+91 6006889027), and live portfolio (akeel-ahmad.netlify.app).
`;
...
function generateContextualReply(query) {
  ...
  if (q.includes('contact') || q.includes('email') || q.includes('phone') || q.includes('hire') || q.includes('reach') || q.includes('linkedin') || q.includes('call') || q.includes('netlify')) {
    return `📬 **Get in Touch with Akeel Ahmad Peerzada:**\n\n• **Email:** [peerakeel9027@gmail.com](mailto:peerakeel9027@gmail.com)\n• **Phone:** [+91 6006889027](tel:+916006889027)\n• **LinkedIn:** [linkedin.com/in/akeel-ahmad-peerzada](https://www.linkedin.com/in/akeel-ahmad-peerzada)\n• **GitHub:** [github.com/AKEEL-AHMAD](https://github.com/AKEEL-AHMAD)\n• **Portfolio:** [akeel-ahmad.netlify.app](https://akeel-ahmad.netlify.app/)\n• **Seeking:** Software Development Engineer (SDE) Intern role.`;
  }

  if (q.includes('cricket') || q.includes('sports') || q.includes('captain')) {
    return `🏏 **Captain, State Cricket Team:**\nAkeel captained the state cricket team and led the squad to **3 tournament championship titles**. The rigor of high-stakes competitive athletics instilled foundational leadership, tactical composure, discipline, and performance consistency under pressure.`;
  }
